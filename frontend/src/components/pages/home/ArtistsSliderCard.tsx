  ...
  return (
    <div className="swiper-slide trending__item round30 p-8">
      <div className="thumb ralt overhid transition">
        ...
        >
          <h5 style={{ textAlign: "center", marginTop: 10 }}>{name_}</h5>
          <button
            className="px-3"
            style={{
          ...
          >
            ...
            >
              <path
                ...
                fillRule="evenodd"
                clipRule="evenodd"
                d="M2.7899 3.82249C5.17644 1.3925 9.04578 1.3925 11.4323 3.82249L12 4.4005L12.5677 3.82249C14.9542 1.3925 18.8236 1.3925 21.2101 3.82249C23.5966 6.25247 23.5966 10.1923 21.2101 12.6222L12 22L2.7899 12.6222C0.403366 10.1923 0.403366 6.25247 2.7899 3.82249Z"
                strokeLinecap="round"
              ></path>
            </svg>
            <span>Follow</span>
