...
const SignUpForm = () => {
  ...
  const handleSignup = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await api.server.POST('/users', { email, password, fullName }, '')
        ...
        <div className="row g-4 justify-content-center">
          <div className="col-lg-6">
            <div className="event__createcover checkout__wrapper">
              ...
              <form action="#shanta" className="cover__form" onSubmit={handleSignup} ref={form}>
                <div className="row g-4">
                  <div className="col-lg-12">
                    <div className="cover__grp">
                      ...
                      <input type="text" name="fullName" id="namess" placeholder="Name" />
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="cover__grp">
