...
export const cart = createSlice({
  ...
  reducers: {
    ...
    cartUpdate: (state, action: PayloadAction<number | string>) => {
    ...
    increaseItem: (state, action: PayloadAction<number | string>) => {
      const id = action.payload;
    ...
    decreaseItem: (state, action: PayloadAction<number | string>) => {
      const id = action.payload;
